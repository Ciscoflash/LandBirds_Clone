          ...
          <form className="lg:px-8 py-8 px-4 md:w-[100%]  mx-auto bg-white">
            ...
            {serviceName === "Design" && (
              <div className="mb-4 grid lg:grid-cols-2 lg:mt-9  gap-3">
                {/* Target Language* */}
                <div className="mb-4">
                  <label htmlFor="DesignType" className="text-left block mb-2">
                    Design Type*
                  </label>
                ...
                {/* upload  */}
                <div className="mb-4  block  items-left">
                  <label
                    htmlFor="file"
                    className="block  text-left cursor-pointer mb-2 "
                  >
                    Upload Sample Design *
                  </label>
                  <label className=" bg-[#f3f5f9] justify-center  p-2 border rounded flex items-center  cursor-pointer">
            ...
            <div className="mb-4 lg:pt-3">
              <label htmlFor="message" className="block mb-2 text-left">
                Give a clear description of the Job
              </label>
